...
<table border="0" width="680">
	...
	<tr><td class="instruc">
        <ul>
			...
			y elige las asignaturas que deseas preinscribir.</li>
           <li style="list-style-type: square;">
		   Las asignaturas seleccionadas o preinscritas se indican con
            <span id="F" class="act"> FONDO AZUL CLARO</span>. Por cada asignatura seleccionada
			se habilita una casilla para la planilla de dep&oacute;sito</li>
P001;
...
P001i;
	...
	if ($_GET['tp'] == '3') { //preinscripciones intensivo
		print <<<P001pi
            <li style="list-style-type: square;">
            Tu selecci&oacute;n ser&aacute; procesada solamente despu&eacute;s de 
			pulsar el bot&oacute;n "Procesar Preinscripci&oacute;n" y escribir de 
			nuevo tu clave.</li>
            <li style="list-style-type: square;">
            PUEDES VOLVER A INGRESAR las veces que lo requieras dentro del 
...
P001pi;
	...
	print <<<P001
             <li style="list-style-type: square;">
            La preinscripci&oacute;n de las asignaturas seleccionadas est&aacute; sujeta
